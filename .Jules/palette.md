...
## 2026-07-25 - Typography Standardization

**Learning:** Maintaining strict adherence to MD3 typographic scales (using `FontWeight.w800` instead of `FontWeight.bold` for expressive headers/labels) ensures visual harmony across components.

**Action:** Standardized font weights to `w800` across various widgets.
