...
**Action:** Enforce a unified `Duration(seconds: 2)` across all copy-to-clipboard SnackBar triggers (such as `AppDetailsInfoRow`, `AICliDialog`, and `AppDetailsHeader`) to streamline lightweight user confirmations.
