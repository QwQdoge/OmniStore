...
polish('zh_Hant', {
    ...
    "aiPickDisclaimer": "條件可用。推薦基於您的使用習慣和目前設定產生，不會影響具體安裝選項。",
    ...
    "githubRepoType": "GitHub 存放庫（owner/repo）",
    "bituRepoType": "Bitu / Bitbucket（工作區/存放庫）",
    "repoOwnerRepo": "軟體源位址（owner/repo）",
    "errorNameUrlRequired": "名稱和連結/軟體源位址不能為空",
    "searchGithubHint": "搜尋 GitHub 存放庫...",
    "flatpakRemoteType": "Flatpak 遠端軟體源",
