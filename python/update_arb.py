...
NEW_KEYS_ZH = {
    ...
    "aurWarning": "安全警告：AUR 软件包由用户贡献，请确保信任其来源。",
    "bootstrapNote": "注意：配置过程可能需要多次输入管理员密码。",
    "feedbackDesc": "遇到问题时，请通过 GitHub 反馈。",
    "aiAssistant": "AI 助手",
    ...
    "gotIt": "知道了",
    "aiOllamaNote": "提示：使用 Ollama 时请确保其已在后台运行并启用了 OLLAMA_ORIGINS=\"*\" 环境变量。",
    "enterStore": "进入商店",
    "nextStep": "下一步",
...
NEW_KEYS_ZH_HANT = {
    ...
    "aurWarning": "安全警告：AUR 套件由使用者貢獻，請確保信任其來源。",
    "bootstrapNote": "注意：配置過程可能需要多次輸入管理員密碼。",
    "feedbackDesc": "遇到問題時，請透過 GitHub 反饋。",
    "aiAssistant": "AI 助手",
    ...
    "gotIt": "知道了",
    "aiOllamaNote": "提示：使用 Ollama 時請確保其已在背景執行並啟用了 OLLAMA_ORIGINS=\"*\" 環境變數。",
    "enterStore": "進入商店",
    "nextStep": "下一步",
