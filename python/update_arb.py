...
NEW_KEYS_ZH = {
    ...
    "envWarningDesc": "部分必要组件缺失，支持自动配置。",
    "envOkDesc": "一切就绪！系统环境完美。",
    "fixProblems": "一键修复/配置",
    "continueAnyway": "仍然继续",
    "sourceConfigTitle": "软件源配置",
    "sourceConfigSubtitle": "选择需要启用的软件源",
    "enableAur": "启用 AUR (Arch User Repository)",
    "yayDesc": "启用 AUR 须安装 yay 助手。",
    "aurWarning": "安全警告：AUR 软件包由用户上传，请确保信任其来源。",
    "bootstrapNote": "注意：配置过程可能需要多次输入管理员密码。",
    "feedbackDesc": "遇到问题请通过 GitHub 反馈。",
    "aiAssistant": "AI 助手",
    "aiAssistantDesc": "启用 AI 驱动的搜索、应用解析及错误诊断",
    "aiProviderDesc": "选择 AI 模型来源（本地或云端）",
    "aiEndpointHelper": "Ollama 默认地址：http://localhost:11434",
    "aiApiKeyHelper": "OpenAI：sk-xxx，Ollama：留空",
    "howToGetApiKey": "如何获取 API 密钥？",
    "howToGetApiKeyDesc": "1. Ollama (本地)：运行即可，无需密钥。2. 云端 (OpenAI)：前往官网创建并输入密钥。",
    "gotIt": "知道了",
    "aiOllamaNote": "注意：使用 Ollama 须开启 OLLAMA_ORIGINS=\"*\" 并在后台运行。",
    "enterStore": "进入商店",
    "nextStep": "下一步",
...
NEW_KEYS_ZH_HANT = {
    ...
    "envWarningDesc": "部分必要組件缺失，可一鍵自動配置。",
    "envOkDesc": "一切就緒！系統環境完美。",
    "fixProblems": "一鍵修復/配置",
    "continueAnyway": "仍然繼續",
    "sourceConfigTitle": "軟體存放庫設定",
    "sourceConfigSubtitle": "選擇需要啟用的軟體存放庫",
    "enableAur": "啟用 AUR (Arch User Repository)",
    "yayDesc": "啟用 AUR 須安裝 yay 助手。",
    "aurWarning": "安全警告：AUR 套件由使用者上傳，請確保信任套件來源。",
    "bootstrapNote": "注意：配置過程可能需要多次輸入管理員密碼。",
    "feedbackDesc": "遇到問題請透過 GitHub 反饋。",
    "aiAssistant": "AI 助手",
    ...
    "howToGetApiKeyDesc": "1. Ollama (本地)：直接執行，無需金鑰。2. 雲端 (OpenAI)：前往官網建立並輸入金鑰。",
    "gotIt": "知道了",
    "aiOllamaNote": "注意：使用 Ollama 須開啟 OLLAMA_ORIGINS=\"*\" 並在背景執行。",
    "enterStore": "進入商店",
    "nextStep": "下一步",
