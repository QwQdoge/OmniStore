...
NEW_KEYS_ZH = {
    ...
    "sourceConfigSubtitle": "选择欲启用的软件源",
    "enableAur": "启用 AUR (Arch User Repository)",
    "yayDesc": "启用 AUR 需要安装 yay 助手。",
    "aurWarning": "安全警告：AUR 软件包由社区贡献，安装前请确认信任来源。",
    "bootstrapNote": "配置过程需多次输入管理员密码。",
    "feedbackDesc": "遇到问题请通过 GitHub 提交反馈。",
    "aiAssistant": "AI 助手",
    "aiAssistantDesc": "启用 AI 驱动的搜索、应用解析及错误诊断",
    "aiProviderDesc": "选择 AI 模型来源（本地或云端）",
    "aiEndpointHelper": "Ollama 默认地址为 http://localhost:11434",
    "aiApiKeyHelper": "Ollama 无需密钥，OpenAI 密钥格式如 sk-xxx",
    "howToGetApiKey": "如何获取 API 密钥？",
    "howToGetApiKeyDesc": "1. Ollama（本地）：运行服务即可，无需密钥。2. 云端服务（OpenAI）：需前往官网创建并输入密钥。",
    "gotIt": "知道了",
    "aiOllamaNote": "Ollama 需在后台运行并启用 OLLAMA_ORIGINS=\"*\" 环境变量。",
    "enterStore": "进入商店",
    "nextStep": "下一步",
...
NEW_KEYS_ZH_HANT = {
    ...
    "sourceConfigSubtitle": "選擇欲啟用的軟體存放庫",
    "enableAur": "啟用 AUR (Arch User Repository)",
    "yayDesc": "啟用 AUR 需要安裝 yay 助手。",
    "aurWarning": "安全警告：AUR 套件由社群貢獻，安裝前請確認信任來源。",
    "bootstrapNote": "配置過程需多次輸入管理員密碼。",
    "feedbackDesc": "遇到問題請透過 GitHub 提交反饋。",
    "aiAssistant": "AI 助手",
    "aiAssistantDesc": "啟用 AI 驅動的搜尋、應用程式解析及錯誤診斷",
    "aiProviderDesc": "選擇 AI 模型來源（本地或雲端）",
    "aiEndpointHelper": "Ollama 預設地址為 http://localhost:11434",
    "aiApiKeyHelper": "Ollama 無需金鑰，OpenAI 金鑰格式如 sk-xxx",
    "howToGetApiKey": "如何獲取 API 金鑰？",
    "howToGetApiKeyDesc": "1. Ollama（本地）：執行服務即可，無需金鑰。2. 雲端服務（OpenAI）：需前往官網建立並輸入金鑰。",
    "gotIt": "知道了",
    "aiOllamaNote": "Ollama 需在背景執行並啟用 OLLAMA_ORIGINS=\"*\" 環境變數。",
    "enterStore": "進入商店",
    "nextStep": "下一步",
