...
NEW_KEYS_ZH = {
    ...
    "feedbackDesc": "遇到问题请通过 GitHub 反馈给我们。",
    "aiAssistant": "AI 助手",
    ...
    "gotIt": "知道了",
    "aiOllamaNote": "使用 Ollama 时请确保其已在后台运行并开启了 OLLAMA_ORIGINS=\"*\" 环境变量。",
    "enterStore": "进入商店",
    "nextStep": "下一步",
...
NEW_KEYS_ZH_HANT = {
    ...
    "feedbackDesc": "遇到問題請透過 GitHub 反饋給我們。",
    "aiAssistant": "AI 助手",
    ...
    "gotIt": "知道了",
    "aiOllamaNote": "使用 Ollama 時請確保其已在背景執行並開啟了 OLLAMA_ORIGINS=\"*\" 環境變數。",
    "enterStore": "進入商店",
    "nextStep": "下一步",
