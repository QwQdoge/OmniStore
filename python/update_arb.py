...
NEW_KEYS_ZH = {
    ...
    "envFatalDesc": "当前系统并非基于 Arch Linux，大部分功能将不可用。",
    "envWarningDesc": "缺少部分必要组件，我们可以为您进行自动配置。",
...
NEW_KEYS_ZH_HANT = {
    ...
    "envFatalDesc": "系統並非基於 Arch Linux，大部分功能將不可用。",
    "envWarningDesc": "缺少部分必要組件，我們可以為您進行自動配置。",
