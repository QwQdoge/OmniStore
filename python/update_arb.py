...
NEW_KEYS_ZH = {
    "welcomeTitle": "欢迎使用 OmniStore",
    "welcomeSubtitle": "简单、优雅的 Arch Linux 应用管理体验",
    "getStarted": "开始使用",
    "skip": "跳过",
    "envCheckTitle": "环境检查",
    "envCheckSubtitle": "确认系统就绪状态",
    "envFatalDesc": "当前系统不是 Arch Linux，核心功能受限。",
    "envWarningDesc": "缺少必要组件，可自动进行配置。",
    "envOkDesc": "一切就绪，系统环境完整。",
    "fixProblems": "自动修复与配置",
    "continueAnyway": "忽略并继续",
    "sourceConfigTitle": "软件源配置",
    "sourceConfigSubtitle": "选择您想要启用的软件源",
    "enableAur": "启用 AUR (Arch User Repository)",
    "yayDesc": "启用 AUR 需安装 yay。",
    "aurWarning": "安全警告：AUR 软件包由用户贡献，安装前需确认来源可信。",
    "bootstrapNote": "配置过程可能需要多次输入管理员密码。",
    "feedbackDesc": "遇到问题可前往 GitHub 提交反馈。",
    "aiAssistant": "AI 助手",
    "aiAssistantDesc": "启用 AI 驱动的搜索、应用解析及错误诊断",
    "aiProviderDesc": "选择 AI 模型来源（本地或云端）",
    "aiEndpointHelper": "Ollama 默认地址：http://localhost:11434",
    "aiApiKeyHelper": "OpenAI 密钥格式为 sk-xxx",
    "howToGetApiKey": "如何获取 API 密钥？",
    "howToGetApiKeyDesc": "1. Ollama：本地运行，无需密钥。2. OpenAI：前往官网创建密钥。",
    "gotIt": "确定",
    "aiOllamaNote": "使用 Ollama 需确保后台运行并启用 OLLAMA_ORIGINS=\"*\" 环境变量。",
    "enterStore": "进入商店",
    "nextStep": "下一步",
    "resetCache": "重置缓存与历史记录",
    "resetCacheDesc": "清空搜索历史与本地推荐缓存",
    "resetCacheConfirm": "确认清空搜索历史与推荐缓存？",
    "resetting": "正在重置...",
    "resetSuccess": "缓存与历史记录已清空",
...
NEW_KEYS_ZH_HANT = {
    "welcomeTitle": "歡迎使用 OmniStore",
    "welcomeSubtitle": "簡單、優雅的 Arch Linux 應用程式管理體驗",
    "getStarted": "開始使用",
    "skip": "跳過",
    "envCheckTitle": "環境檢查",
    "envCheckSubtitle": "確認系統就緒狀態",
    "envFatalDesc": "系統不是 Arch Linux，核心功能受限。",
    "envWarningDesc": "缺少必要組件，可自動進行配置。",
    "envOkDesc": "一切就緒，系統環境完整。",
    "fixProblems": "自動修復與配置",
    "continueAnyway": "忽略並繼續",
    "sourceConfigTitle": "軟體存放庫設定",
    "sourceConfigSubtitle": "選擇您想要啟用的軟體存放庫",
    "enableAur": "啟用 AUR (Arch User Repository)",
    "yayDesc": "啟用 AUR 需安裝 yay。",
    "aurWarning": "安全警告：AUR 套件由使用者貢獻，安裝前需確認來源可信。",
    "bootstrapNote": "配置過程可能需要多次輸入管理員密碼。",
    "feedbackDesc": "遇到問題可前往 GitHub 提交回饋。",
    "aiAssistant": "AI 助手",
    "aiAssistantDesc": "啟用 AI 驅動的搜尋、應用程式解析及錯誤診斷",
    "aiProviderDesc": "選擇 AI 模型來源（本地或雲端）",
    "aiEndpointHelper": "Ollama 預設位址：http://localhost:11434",
    "aiApiKeyHelper": "OpenAI 金鑰格式為 sk-xxx",
    "howToGetApiKey": "如何獲取 API 金鑰？",
    "howToGetApiKeyDesc": "1. Ollama：本地執行，無需金鑰。2. OpenAI：前往官網建立金鑰。",
    "gotIt": "確定",
    "aiOllamaNote": "使用 Ollama 需確保背景執行並啟用 OLLAMA_ORIGINS=\"*\" 環境變數。",
    "enterStore": "進入商店",
    "nextStep": "下一步",
    "resetCache": "重置快取與歷史記錄",
    "resetCacheDesc": "清空搜尋歷史與本地推薦快取",
    "resetCacheConfirm": "確認清空搜尋歷史與推薦快取？",
    "resetting": "正在重置...",
    "resetSuccess": "快取與歷史記錄已清空",
    "resetFailed": "重置失敗: {error}",
    "ollamaLocal": "Ollama (本地)",
    "openaiCompatible": "OpenAI 相容",
    "googleGemini": "Google Gemini",
    "installationDecisionTitle": "安裝決策助手",
    "recommendedSource": "推薦軟體存放庫：{source}",
