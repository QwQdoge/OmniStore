        ...
        children: [
          AnimatedSize(
            ...
            child: AnimatedSwitcher(
              ...
              child: isBusy
                  ? Column(
                      key: const ValueKey('active_task'),
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(
                          l10n.currentTask,
            ...
            Selector<TaskController, ({int length, List<TaskState> history})>(
              ...
              builder: (context, data, child) {
                ...
                return ListView.builder(
                                ...
                                Consumer<TaskController>(
                                  builder: (context, taskController, child) {
                                    return SmoothProgressBar(
                                      taskState: TaskState(
                                        id: "active",
                                        packageName: taskController.packageName ??
                                            l10n.taskProcessing,
                                        status: TaskStatus.downloading,
                                        progress:
                                            taskController.progress ?? 0.0,
                                        stage: taskController.status,
                                        speed: taskController.speed,
                                      ),
                                      onCancel: () =>
                                          taskController.cancelTask(l10n),
                                    );
                                  },
                                ),
                                const SizedBox(height: 16),
                  ...
                  : const SizedBox.shrink(key: ValueKey('no_active_task')),
            ),
          ),
          AnimatedSize(
            duration: const Duration(milliseconds: 300),
            ...
            child: AnimatedSwitcher(
              ...
              child: historyLength > 0
                  ? Column(
                      key: const ValueKey('history_tasks'),
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  ...
                  : const SizedBox.shrink(key: ValueKey('no_history_tasks')),
            ),
          ),
        ],
      ),
