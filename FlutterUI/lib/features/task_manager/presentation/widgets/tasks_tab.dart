...
class TasksTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (!isBusy && historyLength == 0) {
      ...
      // ⚡ Bolt: Switched from SingleChildScrollView + shrinkWrapped ListView to CustomScrollView + SliverList.builder.
      // This restores native scroll virtualization (O(1) rendering) for the completed tasks list.
              ...
              delegate: SliverChildListDelegate([
                ...
                SmoothSizeSwitcher(
                  ...
                  child: historyLength > 0
                      ? Column(
                          key: const ValueKey('task_history_header_block'),
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Row(
