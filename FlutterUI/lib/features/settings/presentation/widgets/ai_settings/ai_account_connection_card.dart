...
class AiAccountConnectionCard extends StatelessWidget {
  ...
  final ValueChanged<String?> onSelectCredential;

  const AiAccountConnectionCard({
    super.key,
