...
class AccountConnectionCard extends StatelessWidget {
  ...
  final VoidCallback onRefreshAccountCredentials;
  ...
  const AccountConnectionCard({
    ...
    required this.onRefreshAccountCredentials,
  ...
  Widget build(BuildContext context) {
    ...
    if (accountCredentialError != null) {
      return ListTile(
        ...
        trailing: IconButton(
          tooltip: '重试',
          onPressed: onRefreshAccountCredentials,
...
class _AccountCallout extends StatelessWidget {
