...
class _MeoChannelCardState extends State<MeoChannelCard> {
  ...
  Future<void> _confirmStableDowngrades(Map<String, dynamic> state) async {
    ...
    final planHash = state['planHash']?.toString();
    if (planHash == null || !RegExp(r'^[0-9a-f]{64}$').hasMatch(planHash)) {
      setState(
        () => _state = {
          ...?_state,
          'status': 'error',
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          FilledButton(
            ...
            child: Text(l10n.switchToStable),
          ),
        ],
      ),
    );
    if (confirmed == true && mounted) {
      await _switch('stable', confirm: true, planHash: planHash);
    }
  }
        ...
        child: Column(
          ...
          children: [
            ...
            if (repositories.isNotEmpty) ...[
              ...
              Text(
                l10n.repoPriority(repositories),
            ...
            if (downgradePending) ...[
              ...
              _StatusPanel(
                ...
                color: theme.colorScheme.primary,
                text: l10n.downgradeReviewPending(
                  (state['downgrades'] as List).length,
                ),
                ...
                Expanded(
                  child: SegmentedButton<String>(
                    segments: [
                      ButtonSegment(
                        value: 'stable',
                        label: Text(l10n.channelStable),
                        icon: const Icon(Icons.verified_outlined),
                        enabled: !_busy && channel != 'stable',
                      ),
                      ButtonSegment(
                        value: 'beta',
                        label: Text(l10n.channelBeta),
