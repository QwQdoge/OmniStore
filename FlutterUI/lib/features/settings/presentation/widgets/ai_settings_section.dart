...
import 'package:frontend/features/settings/presentation/widgets/account_connection_card.dart';
                  ...
                  children: [
                    ...
                    if (provider == 'account') ...[
                      ...
                      AccountConnectionCard(
                        ...
                        isLoadingAccountCredentials: _isLoadingAccountCredentials,
                        accountCredentialError: _accountCredentialError,
                        accountCredentials: _accountCredentials,
                        onOpenAccountSignIn: _openAccountSignIn,
                        onOpenAccountAiSettings: _openAccountAiSettings,
                        onLoadAccountCredentials: () => _loadAccountCredentials(forceRefresh: true),
                        onSelectAccountCredential: _selectAccountCredential,
                      ),
                    ],
