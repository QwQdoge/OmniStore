...
import 'ai_settings/ai_account_connection_card.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (provider == 'account') ...[
                      ...
                      AiAccountConnectionCard(
                        aiConfig: aiConfig,
                        isAuthenticated: _authService.isAuthenticated,
                        isLoading: _isLoadingAccountCredentials,
                        credentials: _accountCredentials,
                        error: _accountCredentialError,
                        onSignIn: _openAccountSignIn,
                        onManageSettings: _openAccountAiSettings,
                        onRefresh: () =>
                            _loadAccountCredentials(forceRefresh: true),
                        onSelectCredential: _selectAccountCredential,
                      ),
                    ],
