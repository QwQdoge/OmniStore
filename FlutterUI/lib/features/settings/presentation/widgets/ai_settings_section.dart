...
import 'account_connection_card.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (provider == 'account') ...[
                      ...
                      AccountConnectionCard(aiConfig: aiConfig, authService: _authService, isLoadingAccountCredentials: _isLoadingAccountCredentials, accountCredentialError: _accountCredentialError, accountCredentials: _accountCredentials, selectAccountCredential: _selectAccountCredential, openAccountAiSettings: _openAccountAiSettings, loadAccountCredentials: _loadAccountCredentials, openAccountSignIn: _openAccountSignIn),
                    ],
