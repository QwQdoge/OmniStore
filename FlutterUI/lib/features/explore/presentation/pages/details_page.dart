...
class _AppDetailsPageState extends State<AppDetailsPage> {
  ...
  Future<void> _handleAction(String flag) async {
    ...
    if (!isUninstall) {
      final decision = await BackendService.instance.getInstallationDecision(
        widget.app.name,
        widget.app.variants,
      );
      if (!mounted) return;
      ...
      if (!mounted) return;
      if (recommended != null && widget.app.sources.contains(recommended)) {
        setState(() => _selectedSource = recommended);
      }
    }
