...
class EnvCheckPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final envDataVal = envData;

    final level = envDataVal != null
        ? _evaluateEnvLevel(envDataVal)
        : 'unknown';
            ...
            child: isCheckingEnv
                ...
                : Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      _buildEnvDetailsGrid(envDataVal, theme),
                    ],
                  ),
          ),
        ],
