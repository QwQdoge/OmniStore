...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get syncStatusSubtitle => '应用和设置已备份';

  @override
  String get manageAccount => '管理账户';

  @override
  String get manageAccountSubtitle => '安全、多因素认证（MFA）及会话管理';

  @override
  String get signInToMeoArch => '登录 MeoArch 账户';

  @override
  String get signInSubtitle => '跨设备同步您的应用、设置及收藏項目。';
  ...
  @override
  String get continueWithGitHub => '使用 GitHub 登录';
...
class AppLocalizationsZhHant extends AppLocalizationsZh {
  ...
  @override
  String get syncStatusSubtitle => '應用程式與設定已備份';

  @override
  String get manageAccount => '管理帳戶';

  @override
  String get manageAccountSubtitle => '安全性、多因素驗證（MFA）與工作階段';

  @override
  String get signInToMeoArch => '登入 MeoArch 帳戶';

  @override
  String get signInSubtitle => '跨裝置同步您的應用程式、設定與收藏項目。';
  ...
  @override
  String get continueWithGitHub => '使用 GitHub 登入';

  @override
  String get enterEmailPassword => '請輸入電子郵件和密碼。';
