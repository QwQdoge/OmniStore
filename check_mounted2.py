            ...
            for i, line in enumerate(lines):
                if 'await ' in line:
                    ...
                    if 'mounted' not in block:
                        if re.search(r'context\.(read|watch|pop|push)|ScaffoldMessenger\.of\(context\)|Navigator\.(of\(context\)|push|pop)|Theme\.of\(context\)|AppLocalizations\.of\(context\)', block):
